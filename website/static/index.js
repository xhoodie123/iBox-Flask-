...
// Make 'enter' key submit message
    ...
    // Retrieve email
    const email = document.querySelector('#get-email').innerHTML;
    ...
    socket.on('message', data => {
        ...
        if (data.msg) {
            ...
            if (data.email == email) {
                    ...
                    // email
                    span_email.setAttribute("class", "my-email");
                    ...
                    // HTML to append
                    p.innerHTML += span_email.outerHTML + br.outerHTML + data.msg + br.outerHTML + span_timestamp.outerHTML
            ...
            // Display other users' messages
                ...
                // email
                span_email.setAttribute("class", "other-email");
                span_email.innerText = data.email;
    ...
    function leaveRoom(room) {
        socket.emit('leave', {'email': email, 'room': room});
    ...
    function joinRoom(room) {
        ...
        // Join room
        socket.emit('join', {'email': email, 'room': room});
